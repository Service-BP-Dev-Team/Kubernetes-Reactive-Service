...
public class MainForArray {
	...
	public static void main1() {
		...
		// System.out.println("the size of root tasks is : "+
		// exec.getConfiguration().getRoot().getSubTasks().size());
	...
	public static void main2() {
		...
		// execute the gag
		GAG g = InMemoryWorkspace.getGagWithRootFolder("spec-simple-array");

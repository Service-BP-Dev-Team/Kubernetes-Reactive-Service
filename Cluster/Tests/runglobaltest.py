...
env_variables = {
  ...
  #  'NUMBER_OF_BLOCKS': 32,
    ...
    'VARYING' : 'MAX_LEN', # possible case are NUMBER_OF_BLOCKS,  WORKER_REQUEST_FAILURE_PROBABILITY, NUMBER_OF_WORKER_PODS, or MAX_LEN
    'WORKER_REQUEST_FAILURE_PROBABILITY':0.0,
    "NUMBER_OF_BLOCKS": 64,
    #'STEP_INCREMENT' : 1,
    "STEP_SET": [5860, 11719, 23438, 46875, 93750],
